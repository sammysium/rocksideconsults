...
import AreaMappingGestureHandler from './AreaMappingGestureHandler';

const AnimatedPolygon = Animated.createAnimatedComponent(Polygon);

export default function InputAreaMapping() {
  ...
  const [points, setPoints] = useState<typeof TTouchPoint[]>([]);
